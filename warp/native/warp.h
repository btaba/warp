...
WP_API bool wp_memcpy_batch(void* context, void** dsts, void** srcs, size_t* sizes, size_t count, void* stream=WP_CURRENT_STREAM);
...
WP_API bool wp_cuda_graph_insert_memcpy_batch(void* context, void* stream, void** dsts, void** srcs, size_t* sizes, int* kinds, int count, void** nodes_ret);
WP_API bool wp_cuda_graph_update_memcpy(void* graph_exec, void* node, void* dst, void* src, size_t size, int kind);
WP_API bool wp_cuda_graph_update_memcpy_batch(void* graph_exec, void** nodes, void** dsts, void** srcs, size_t* sizes, int* kinds, int count);
